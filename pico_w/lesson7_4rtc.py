...
import time
import urequests
#https://hook.us1.make.com/4o3a7rhnwpx2h4bwbwow2fvqi13sx2c6?date={date_str}&temperature={temp}&from=學院養魚場
...
def alert(temp):
    ...
    if time.ticks_diff(time.ticks_ms(), start_time) >= duration * 1000:
        ...
        url_str = f'https://hook.eu2.make.com/4o3a7rhnwpx2h4bwbwow2fvqi13sx2c6?date={date_str}&temperature={temp}&from=學院養魚場'
        try:
